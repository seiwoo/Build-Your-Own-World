...
public class Tileset {
    ...
    public static final TETile WALL = new TETile('#', new Color(199, 100, 100), Color.red,
            "wall", 1);
    public static final TETile FLOOR = new TETile('·', new Color(128, 192, 128), Color.green, "floor", 2);
